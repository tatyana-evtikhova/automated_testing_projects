...
def test_get_all_memes_unauthorized(get_all_memes_endpoint):
    response = get_all_memes_endpoint.get_all_memes_unauthorized()
    get_all_memes_endpoint.check_status_is_401(response)


def test_get_one_meme_unauthorized(get_meme_endpoint, meme_id):
    response = get_meme_endpoint.get_meme_unauthorized(meme_id)
    get_meme_endpoint.check_status_is_401(response)


def test_create_meme_unauthorized(create_meme_endpoint):
    response = create_meme_endpoint.new_meme_unauthorized(payload)
    create_meme_endpoint.check_status_is_401(response)


def test_edit_meme_unauthorized(edit_meme_endpoint, meme_id, editable_meme):
    response = edit_meme_endpoint.edit_meme_unauthorized(meme_id, editable_meme)
    edit_meme_endpoint.check_status_is_401(response)


def test_delete_meme_unauthorized(delete_meme_endpoint, meme_id):
    response = delete_meme_endpoint.delete_meme_by_id_unauthorized(meme_id)
    delete_meme_endpoint.check_status_is_401(response)
...
def test_create_meme_and_delete_as_different_user(create_meme_endpoint, delete_meme_endpoint, authorize_endpoint):
    response = create_meme_endpoint.create_meme_as_mascot(payload)
    create_meme_endpoint.check_status_is_200(response)
